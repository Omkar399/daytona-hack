            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 flex items-center gap-2">
                  <RiFlaskLine size={24} className="text-neutral-700 dark:text-neutral-300" />
                  Your Experiments
                  {experiments && (
                    <span className="text-base text-neutral-500 dark:text-neutral-400 font-normal">
                      ({experiments.length})
                    </span>
                  )}
                </h2>
              ...
              {isLoadingExperiments ? (
                <Card>
                  <CardContent className="py-12 text-center">
                    <RiLoader4Line size={32} className="mx-auto mb-3 text-neutral-400 dark:text-neutral-500 animate-spin" />
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">Loading experiments...</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="py-12 text-center">
                    <RiFlaskLine size={48} className="mx-auto mb-3 text-neutral-300 dark:text-neutral-600" />
